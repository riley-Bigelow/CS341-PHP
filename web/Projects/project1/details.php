						...
						<ul id="recipeList" class = "results">
							<li>
								...
								<div class= "topnav">
									...
									<?php
									$statement = $db->prepare('SELECT recipeid, isplanned FROM recipes Where deletedat IS NULL AND recipeid = :id');
									$statement->execute(array(':id' => $id));
									...
									echo '<a href="action_deleteRecipe.php?id='.$row['recipeid'].'" class="button"><img src="trash.png" style="width:42px;height:42px;"><br>Delete Recipe</a>';
									?>
    							</div>
							</li>
						</ul>
