				...
				<div class ="content">
					...
					<div class="display">
						<ul id="recipeList" class = "results">
							<?php
								$statement = $db->prepare('SELECT DISTINCT recipes.recipeid,recipename FROM ingredients INNER JOIN recipes ON ingredients.recipeid = recipes.recipeid WHERE  recipes.deletedat IS NULL and ingredients.deletedat IS NULL AND Lower(ingredients.ingredientname) = Lower(:ingredient)');
